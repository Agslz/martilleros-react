        ...
        {items.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "flex min-w-[4.75rem] max-w-[5.5rem] shrink-0 flex-col items-center justify-center gap-1 rounded-xl px-2 py-2 text-center transition-colors",
                active
            ...
            >
              ...
              <span className="w-full text-[10px] font-medium leading-tight line-clamp-2">
                {label}
              </span>
            </Link>
          )
